...
<tr>
    <td valign="top" class="edittext"[{if $tes_haendleranzeige_isDealer }] style="background-color: [{ $tes_haendleranzeige_bgcolor }];"[{/if}]>
        ...
        [{block name="admin_user_main_form"}]
            ...
            <tr>
                ...
                [{ $groupsActiveTest }]
                [{if $tes_haendleranzeige_isDealer }]<span style="color: [{ $tes_haendleranzeige_color }];">[{ oxmultilang ident="GENERAL_YES" }]</span>[{else}][{ oxmultilang ident="GENERAL_NO" }][{/if}]
